...
?>
	...
	if(isset($_POST['login'])){
		$user = mysql_real_escape_string($koneksi, htmlentities($_POST['username']));
		$pass = mysql_real_escape_string($koneksi, htmlentities(md5($_POST['password'])));

		$sql = mysql_query($koneksi, "SELECT * FROM tbl_mahasiswa WHERE username='$user' AND password='$pass'") or die(mysqli_error($koneksi));
